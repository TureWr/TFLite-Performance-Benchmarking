...
public final class ActivityMainNewBinding implements ViewBinding {
  ...
  private ActivityMainNewBinding(@NonNull LinearLayout rootView, @NonNull Button benchmarkButton,
  ...
  public static ActivityMainNewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainNewBinding((LinearLayout) rootView, benchmarkButton,
