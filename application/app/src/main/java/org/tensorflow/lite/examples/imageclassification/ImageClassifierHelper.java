...
public class ImageClassifierHelper {
    ...
    private static final int MODEL_MOBILENETV2_TF2 = 0;
    private static final int MODEL_ANOMALY = 1;
    ...
    private void setupImageClassifier() {
        ...
        String modelName;
        switch (currentModel) {
            case MODEL_MOBILENETV2_TF2:
                modelName = "mobilenetv2tf2.tflite"; // Added for MobileNetV2
                break;
//            case MODEL_ANOMALY:
//                // TODO: CHANGE WHEN NEW MODEL IS IMPLEMENTED!!
//                modelName = "mobilenetv2tf2.tflite"; // Added for MobileNetV2
//
//                break;
            default:
                Log.d("myInfo", "DEFAULT MODEL!!!");
                modelName = "toDelete/mobilenetv1.tflite";
        }
        try {
            imageClassifier =
